...
export function createSessionValidator(options?: SessionValidationOptions): Middleware<BotContext> {
  const {
    autoInitialize = true,
 ...
 */
export function isSessionActive(ctx: BotContext, maxInactiveTime: number = 30 * 60 * 1000): boolean {
